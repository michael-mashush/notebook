...
const LIST_ITEM_TEST_ID = 'list-item';

describe('shared/ui/list/list-item:', () => {
  ...
  describe('The component successfully processes all properties', () => {
    ...
    describe('Default attributes', () => {
      ...
      describe('className', () => {
        ...
        const values: Exclude<ListItemProps['className'], undefined>[] = [
          `${v4()}`,
          `${v4()}`,
          `${v4()}`,
          `${v4()}`,
        ...
        for (const value of values) {
          test(`"className" is equal to "${value}"`, () => {
            ...
            expect(screen.getByTestId(LIST_ITEM_TEST_ID)).toBeInTheDocument();
            expect(screen.getByTestId(LIST_ITEM_TEST_ID)).toHaveClass(value);
          });
        }
    ...
    describe('Special properties', () => {
      ...
      describe('children', () => {
        ...
        const values: Exclude<ListItemProps['children'], undefined>[] = [
          `${v4()}`,
          `${v4()}`,
          `${v4()}`,
          `${v4()}`,
        ...
        for (const value of values) {
          test(`"children" is equal to "${value}"`, () => {
            ...
            render(component, RENDER_OPTIONS);
            expect(screen.getByTestId(LIST_ITEM_TEST_ID)).toBeInTheDocument();
            expect(screen.getByTestId(LIST_ITEM_TEST_ID)).toHaveTextContent(String(value));
          });
        }
    ...
    describe('Event attributes', () => {
      ...
      test('onContextMenu', () => {
        ...
        fireEvent.contextMenu(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onKeyDown', () => {
        ...
        fireEvent.keyDown(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onKeyUp', () => {
        ...
        fireEvent.keyUp(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onClick', () => {
        ...
        fireEvent.click(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onDoubleClick', () => {
        ...
        fireEvent.doubleClick(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onMouseDown', () => {
        ...
        fireEvent.mouseDown(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onMouseEnter', () => {
        ...
        fireEvent.mouseEnter(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onMouseLeave', () => {
        ...
        fireEvent.mouseLeave(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onMouseMove', () => {
        ...
        fireEvent.mouseMove(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onMouseOut', () => {
        ...
        fireEvent.mouseOut(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onMouseOver', () => {
        ...
        fireEvent.mouseOver(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onMouseUp', () => {
        ...
        fireEvent.mouseUp(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onPointerCancel', () => {
        ...
        fireEvent.pointerCancel(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onPointerDown', () => {
        ...
        fireEvent.pointerDown(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onPointerEnter', () => {
        ...
        fireEvent.pointerEnter(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onPointerLeave', () => {
        ...
        fireEvent.pointerLeave(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onPointerMove', () => {
        ...
        fireEvent.pointerMove(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onPointerOut', () => {
        ...
        fireEvent.pointerOut(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onPointerOver', () => {
        ...
        fireEvent.pointerOver(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onPointerUp', () => {
        ...
        fireEvent.pointerUp(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onTouchCancel', () => {
        ...
        fireEvent.touchCancel(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onTouchEnd', () => {
        ...
        fireEvent.touchEnd(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onTouchMove', () => {
        ...
        fireEvent.touchMove(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onTouchStart', () => {
        ...
        fireEvent.touchStart(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onWheel', () => {
        ...
        fireEvent.wheel(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onScroll', () => {
        ...
        fireEvent.scroll(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onDrag', () => {
        ...
        fireEvent.drag(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onDragEnd', () => {
        ...
        fireEvent.dragEnd(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onDragEnter', () => {
        ...
        fireEvent.dragEnter(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onDragLeave', () => {
        ...
        fireEvent.dragLeave(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onDragOver', () => {
        ...
        fireEvent.dragOver(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onDragStart', () => {
        ...
        fireEvent.dragStart(screen.getByTestId(LIST_ITEM_TEST_ID));
      ...
      test('onDrop', () => {
        ...
        fireEvent.drop(screen.getByTestId(LIST_ITEM_TEST_ID));
