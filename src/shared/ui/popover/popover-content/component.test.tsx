...
describe('shared/ui/popover/popover-content', () => {
  ...
  describe('properties', () => {
    ...
    describe('the component should render with the correct "className"', () => {
      ...
      it('renders correctly without "className"', () => {
        ...
        expect(screen.getByTestId(POPOVER_CONTENT_TEST_ID)).toHaveClass(PopoverContentClasses['popover-content']);
      });
      ...
      it('renders correctly with single "className"', () => {
        ...
        expect(screen.getByTestId(POPOVER_CONTENT_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(POPOVER_CONTENT_TEST_ID)).toHaveClass(PopoverContentClasses['popover-content'], className1);
      });
      ...
      it('renders correctly with multiple "className"', () => {
        ...
        expect(screen.getByTestId(POPOVER_CONTENT_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(POPOVER_CONTENT_TEST_ID)).toHaveClass(PopoverContentClasses['popover-content'], className1, className2);
      });

    });

    describe('the component should render with the correct "triggerWidth"', () => {

      it('renders correctly without "triggerWidth"', () => {
        render(
          <Popover data-testid={POPOVER_TEST_ID} opened>
            <PopoverTrigger>
              <Button
        ...
        expect(screen.getByTestId(POPOVER_CONTENT_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(POPOVER_CONTENT_TEST_ID)).toHaveStyle('max-width: auto;');
        expect(screen.getByTestId(POPOVER_CONTENT_TEST_ID)).toHaveStyle('min-width: auto;');
      });

      it('renders correctly with "triggerWidth" equal to "false"', () => {
        render(
          <Popover data-testid={POPOVER_TEST_ID} opened>
            <PopoverTrigger>
              <Button
      ...
      it('renders correctly with "triggerWidth" equal to "true"', () => {
        render(
          <Popover data-testid={POPOVER_TEST_ID} opened>
            <PopoverTrigger>
              <Button
        ...
        expect(screen.getByTestId(POPOVER_CONTENT_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(POPOVER_CONTENT_TEST_ID)).not.toHaveStyle('max-width: auto;');
        expect(screen.getByTestId(POPOVER_CONTENT_TEST_ID)).not.toHaveStyle('min-width: auto;');
      });
  ...
  describe('event handling', () => {
    ...
    describe('keyboard events', () => {
      ...
      it('the component should handle "keydown" event', () => {
        ...
        fireEvent.keyDown(screen.getByTestId(POPOVER_CONTENT_TEST_ID));
      ...
      it('the component should handle "keyup" event', () => {
        ...
        fireEvent.keyUp(screen.getByTestId(POPOVER_CONTENT_TEST_ID));
    ...
    describe('mouse events', () => {
      ...
      it('the component should handle "click" event', () => {
        ...
        fireEvent.click(screen.getByTestId(POPOVER_CONTENT_TEST_ID));
      ...
      it('the component should handle "doubleclick" event', () => {
        ...
        fireEvent.doubleClick(screen.getByTestId(POPOVER_CONTENT_TEST_ID));
      ...
      it('the component should handle "mousedown" event', () => {
        ...
        fireEvent.mouseDown(screen.getByTestId(POPOVER_CONTENT_TEST_ID));
      ...
      it('the component should handle "mouseenter" event', () => {
        ...
        fireEvent.mouseEnter(screen.getByTestId(POPOVER_CONTENT_TEST_ID));
      ...
      it('the component should handle "mouseleave" event', () => {
        ...
        fireEvent.mouseLeave(screen.getByTestId(POPOVER_CONTENT_TEST_ID));
      ...
      it('the component should handle "mousemove" event', () => {
        ...
        fireEvent.mouseMove(screen.getByTestId(POPOVER_CONTENT_TEST_ID));
      ...
      it('the component should handle "mouseout" event', () => {
        ...
        fireEvent.mouseOut(screen.getByTestId(POPOVER_CONTENT_TEST_ID));
      ...
      it('the component should handle "mouseover" event', () => {
        ...
        fireEvent.mouseOver(screen.getByTestId(POPOVER_CONTENT_TEST_ID));
      ...
      it('the component should handle "mouseup" event', () => {
        ...
        fireEvent.mouseUp(screen.getByTestId(POPOVER_CONTENT_TEST_ID));
      ...
      it('the component should handle "wheel" event', () => {
        ...
        fireEvent.wheel(screen.getByTestId(POPOVER_CONTENT_TEST_ID));
    ...
    describe('touch events', () => {
      ...
      it('the component should handle "touchcancel" event', () => {
        ...
        fireEvent.touchCancel(screen.getByTestId(POPOVER_CONTENT_TEST_ID));
      ...
      it('the component should handle "touchend" event', () => {
        ...
        fireEvent.touchEnd(screen.getByTestId(POPOVER_CONTENT_TEST_ID));
      ...
      it('the component should handle "touchmove" event', () => {
        ...
        fireEvent.touchMove(screen.getByTestId(POPOVER_CONTENT_TEST_ID));
      ...
      it('the component should handle "touchstart" event', () => {
        ...
        fireEvent.touchStart(screen.getByTestId(POPOVER_CONTENT_TEST_ID));
    ...
    describe('pointer events', () => {
      ...
      it('the component should handle "pointercancel" event', () => {
        ...
        fireEvent.pointerCancel(screen.getByTestId(POPOVER_CONTENT_TEST_ID));
      ...
      it('the component should handle "pointerdown" event', () => {
        ...
        fireEvent.pointerDown(screen.getByTestId(POPOVER_CONTENT_TEST_ID));
      ...
      it('the component should handle "pointerenter" event', () => {
        ...
        fireEvent.pointerEnter(screen.getByTestId(POPOVER_CONTENT_TEST_ID));
      ...
      it('the component should handle "pointerleave" event', () => {
        ...
        fireEvent.pointerLeave(screen.getByTestId(POPOVER_CONTENT_TEST_ID));
      ...
      it('the component should handle "pointermove" event', () => {
        ...
        fireEvent.pointerMove(screen.getByTestId(POPOVER_CONTENT_TEST_ID));
      ...
      it('the component should handle "pointerout" event', () => {
        ...
        fireEvent.pointerOut(screen.getByTestId(POPOVER_CONTENT_TEST_ID));
      ...
      it('the component should handle "pointerover" event', () => {
        ...
        fireEvent.pointerOver(screen.getByTestId(POPOVER_CONTENT_TEST_ID));
      ...
      it('the component should handle "pointerup" event', () => {
        ...
        fireEvent.pointerUp(screen.getByTestId(POPOVER_CONTENT_TEST_ID));
  ...
  describe('accessibility', () => {
    ...
    describe('the component should render with the correct accessible role', () => {
      ...
      it('renders correctly with default accessible role', () => {
        ...
        expect(screen.getByTestId(POPOVER_CONTENT_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(POPOVER_CONTENT_TEST_ID)).toHaveRole('generic');
      });

      it('renders correctly with accessible role', () => {
        const role: PopoverContentProps['role'] = 'none';
        render(
          <Popover data-testid={POPOVER_TEST_ID} opened>
            <PopoverTrigger>
              <Button
        ...
        expect(screen.getByTestId(POPOVER_CONTENT_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(POPOVER_CONTENT_TEST_ID)).toHaveRole(role);
      });
    ...
    describe('the component should render with the correct accessible name', () => {
      ...
      it('renders correctly without accessible name', () => {
        ...
        expect(screen.getByTestId(POPOVER_CONTENT_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(POPOVER_CONTENT_TEST_ID)).not.toHaveAccessibleName();
      });

      it('renders correctly with accessible name', () => {
        const ariaLabel: PopoverContentProps['aria-label'] = 'popover-content';
        render(
          <Popover data-testid={POPOVER_TEST_ID} opened>
            <PopoverTrigger>
              <Button
        ...
        expect(screen.getByTestId(POPOVER_CONTENT_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(POPOVER_CONTENT_TEST_ID)).toHaveAccessibleName(ariaLabel);
      });
