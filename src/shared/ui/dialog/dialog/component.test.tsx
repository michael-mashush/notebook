...
const DIALOG_TEST_ID = v4();

describe('shared/ui/dialog/dialog', () => {
  ...
  describe('properties', () => {
    ...
    describe('the component should render with the correct "children"', () => {
      ...
      it('renders correctly without "children"', () => {
        render(
          <Dialog data-testid={DIALOG_TEST_ID} opened />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(DIALOG_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(DIALOG_TEST_ID)).toBeEmptyDOMElement();
      });
      ...
      it('renders correctly with "children"', () => {
        ...
        expect(screen.getByTestId(DIALOG_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(DIALOG_TEST_ID)).not.toBeEmptyDOMElement();
        expect(screen.getByTestId(DIALOG_TEST_ID)).toHaveTextContent(textContent);
      });
    ...
    describe('the component should render with the correct "className"', () => {
      ...
      it('renders correctly without "className"', () => {
        ...
        expect(screen.getByTestId(DIALOG_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(DIALOG_TEST_ID)).toHaveClass(DialogClasses['dialog']);
      });
      ...
      it('renders correctly with single "className"', () => {
        ...
        expect(screen.getByTestId(DIALOG_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(DIALOG_TEST_ID)).toHaveClass(DialogClasses['dialog'], className1);
      });
      ...
      it('renders correctly with multiple "className"', () => {
        ...
        expect(screen.getByTestId(DIALOG_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(DIALOG_TEST_ID)).toHaveClass(DialogClasses['dialog'], className1, className2);
      });
    ...
    describe('the component should render with the correct "opened"', () => {
      ...
      it('renders correctly without "opened"', () => {
        render(
          <Dialog data-testid={DIALOG_TEST_ID} />,
          RENDER_OPTIONS
        );
      ...
      it('renders correctly with "opened" equal to "false"', () => {
        render(
          <Dialog data-testid={DIALOG_TEST_ID} opened={false} />,
          RENDER_OPTIONS
        );
        expect(screen.queryByTestId(DIALOG_TEST_ID)).not.toBeInTheDocument();
      });
      ...
      it('renders correctly with "opened" equal to "true"', () => {
        render(
          <Dialog data-testid={DIALOG_TEST_ID} opened={true} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(DIALOG_TEST_ID)).toBeInTheDocument();
      });
  ...
  describe('event handling', () => {
    ...
    describe('keyboard events', () => {
      ...
      it('the component should handle "keydown" event', () => {
        ...
        fireEvent.keyDown(screen.getByTestId(DIALOG_TEST_ID));
      ...
      it('the component should handle "keyup" event', () => {
        ...
        fireEvent.keyUp(screen.getByTestId(DIALOG_TEST_ID));
    ...
    describe('mouse events', () => {
      ...
      it('the component should handle "click" event', () => {
        ...
        fireEvent.click(screen.getByTestId(DIALOG_TEST_ID));
      ...
      it('the component should handle "doubleclick" event', () => {
        ...
        fireEvent.doubleClick(screen.getByTestId(DIALOG_TEST_ID));
      ...
      it('the component should handle "mousedown" event', () => {
        ...
        fireEvent.mouseDown(screen.getByTestId(DIALOG_TEST_ID));
      ...
      it('the component should handle "mouseenter" event', () => {
        ...
        fireEvent.mouseEnter(screen.getByTestId(DIALOG_TEST_ID));
      ...
      it('the component should handle "mouseleave" event', () => {
        ...
        fireEvent.mouseLeave(screen.getByTestId(DIALOG_TEST_ID));
      ...
      it('the component should handle "mousemove" event', () => {
        ...
        fireEvent.mouseMove(screen.getByTestId(DIALOG_TEST_ID));
      ...
      it('the component should handle "mouseout" event', () => {
        ...
        fireEvent.mouseOut(screen.getByTestId(DIALOG_TEST_ID));
      ...
      it('the component should handle "mouseover" event', () => {
        ...
        fireEvent.mouseOver(screen.getByTestId(DIALOG_TEST_ID));
      ...
      it('the component should handle "mouseup" event', () => {
        ...
        fireEvent.mouseUp(screen.getByTestId(DIALOG_TEST_ID));
      ...
      it('the component should handle "wheel" event', () => {
        ...
        fireEvent.wheel(screen.getByTestId(DIALOG_TEST_ID));
    ...
    describe('touch events', () => {
      ...
      it('the component should handle "touchcancel" event', () => {
        ...
        fireEvent.touchCancel(screen.getByTestId(DIALOG_TEST_ID));
      ...
      it('the component should handle "touchend" event', () => {
        ...
        fireEvent.touchEnd(screen.getByTestId(DIALOG_TEST_ID));
      ...
      it('the component should handle "touchmove" event', () => {
        ...
        fireEvent.touchMove(screen.getByTestId(DIALOG_TEST_ID));
      ...
      it('the component should handle "touchstart" event', () => {
        ...
        fireEvent.touchStart(screen.getByTestId(DIALOG_TEST_ID));
    ...
    describe('pointer events', () => {
      ...
      it('the component should handle "pointercancel" event', () => {
        ...
        fireEvent.pointerCancel(screen.getByTestId(DIALOG_TEST_ID));
      ...
      it('the component should handle "pointerdown" event', () => {
        ...
        fireEvent.pointerDown(screen.getByTestId(DIALOG_TEST_ID));
      ...
      it('the component should handle "pointerenter" event', () => {
        ...
        fireEvent.pointerEnter(screen.getByTestId(DIALOG_TEST_ID));
      ...
      it('the component should handle "pointerleave" event', () => {
        ...
        fireEvent.pointerLeave(screen.getByTestId(DIALOG_TEST_ID));
      ...
      it('the component should handle "pointermove" event', () => {
        ...
        fireEvent.pointerMove(screen.getByTestId(DIALOG_TEST_ID));
      ...
      it('the component should handle "pointerout" event', () => {
        ...
        fireEvent.pointerOut(screen.getByTestId(DIALOG_TEST_ID));
      ...
      it('the component should handle "pointerover" event', () => {
        ...
        fireEvent.pointerOver(screen.getByTestId(DIALOG_TEST_ID));
      ...
      it('the component should handle "pointerup" event', () => {
        ...
        fireEvent.pointerUp(screen.getByTestId(DIALOG_TEST_ID));
    ...
    describe('custom events', () => {
      ...
      it('the component should handle "close" event', async () => {
        ...
        await userEvent.click(screen.getByTestId(DIALOG_TEST_ID).parentElement!.previousElementSibling!);
  ...
  describe('accessibility', () => {
    ...
    describe('the component should render with the correct accessible role', () => {
      ...
      it('renders correctly with default accessible role', () => {
        ...
        expect(screen.getByTestId(DIALOG_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(DIALOG_TEST_ID)).toHaveRole('dialog');
      });

      it('renders correctly with accessible role', () => {
        const role: DialogProps['role'] = 'none';
        render(
          <Dialog
            data-testid={DIALOG_TEST_ID}
            opened
        ...
        expect(screen.getByTestId(DIALOG_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(DIALOG_TEST_ID)).toHaveRole(role);
      });
    ...
    describe('the component should render with the correct accessible name', () => {
      ...
      it('renders correctly without accessible name', () => {
        ...
        expect(screen.getByTestId(DIALOG_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(DIALOG_TEST_ID)).not.toHaveAccessibleName();
      });

      it('renders correctly with accessible name', () => {
        const ariaLabel: DialogProps['aria-label'] = 'dialog';
        render(
          <Dialog
            data-testid={DIALOG_TEST_ID}
            opened
        ...
        expect(screen.getByTestId(DIALOG_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(DIALOG_TEST_ID)).toHaveAccessibleName(ariaLabel);
      });
