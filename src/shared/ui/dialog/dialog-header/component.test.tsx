...
const DIALOG_HEADER_TEST_ID = v4();

describe('shared/ui/dialog/dialog-header', () => {
  ...
  describe('properties', () => {
    ...
    describe('the component should render with the correct "children"', () => {
      ...
      it('renders correctly without "children"', () => {
        render(
          <DialogHeader data-testid={DIALOG_HEADER_TEST_ID}  />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(DIALOG_HEADER_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(DIALOG_HEADER_TEST_ID)).toBeEmptyDOMElement();
      });
      ...
      it('renders correctly with "children"', () => {
        ...
        render(
          <DialogHeader
            data-testid={DIALOG_HEADER_TEST_ID}
            children={textContent}
          />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(DIALOG_HEADER_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(DIALOG_HEADER_TEST_ID)).not.toBeEmptyDOMElement();
        expect(screen.getByTestId(DIALOG_HEADER_TEST_ID)).toHaveTextContent(textContent);
      });
    ...
    describe('the component should render with the correct "className"', () => {
      ...
      it('renders correctly without "className"', () => {
        ...
        expect(screen.getByTestId(DIALOG_HEADER_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(DIALOG_HEADER_TEST_ID)).toHaveClass(DialogHeaderClasses['dialog-header']);
      });
      ...
      it('renders correctly with single "className"', () => {
        ...
        expect(screen.getByTestId(DIALOG_HEADER_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(DIALOG_HEADER_TEST_ID)).toHaveClass(DialogHeaderClasses['dialog-header'], className1);
      });
      ...
      it('renders correctly with multiple "className"', () => {
        ...
        expect(screen.getByTestId(DIALOG_HEADER_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(DIALOG_HEADER_TEST_ID)).toHaveClass(DialogHeaderClasses['dialog-header'], className1, className2);
      });
  ...
  describe('event handling', () => {
    ...
    describe('keyboard events', () => {
      ...
      it('the component should handle "keydown" event', () => {
        ...
        fireEvent.keyDown(screen.getByTestId(DIALOG_HEADER_TEST_ID));
      ...
      it('the component should handle "keyup" event', () => {
        ...
        fireEvent.keyUp(screen.getByTestId(DIALOG_HEADER_TEST_ID));
    ...
    describe('mouse events', () => {
      ...
      it('the component should handle "click" event', () => {
        ...
        fireEvent.click(screen.getByTestId(DIALOG_HEADER_TEST_ID));
      ...
      it('the component should handle "doubleclick" event', () => {
        ...
        fireEvent.doubleClick(screen.getByTestId(DIALOG_HEADER_TEST_ID));
      ...
      it('the component should handle "mousedown" event', () => {
        ...
        fireEvent.mouseDown(screen.getByTestId(DIALOG_HEADER_TEST_ID));
      ...
      it('the component should handle "mouseenter" event', () => {
        ...
        fireEvent.mouseEnter(screen.getByTestId(DIALOG_HEADER_TEST_ID));
      ...
      it('the component should handle "mouseleave" event', () => {
        ...
        fireEvent.mouseLeave(screen.getByTestId(DIALOG_HEADER_TEST_ID));
      ...
      it('the component should handle "mousemove" event', () => {
        ...
        fireEvent.mouseMove(screen.getByTestId(DIALOG_HEADER_TEST_ID));
      ...
      it('the component should handle "mouseout" event', () => {
        ...
        fireEvent.mouseOut(screen.getByTestId(DIALOG_HEADER_TEST_ID));
      ...
      it('the component should handle "mouseover" event', () => {
        ...
        fireEvent.mouseOver(screen.getByTestId(DIALOG_HEADER_TEST_ID));
      ...
      it('the component should handle "mouseup" event', () => {
        ...
        fireEvent.mouseUp(screen.getByTestId(DIALOG_HEADER_TEST_ID));
      ...
      it('the component should handle "wheel" event', () => {
        ...
        fireEvent.wheel(screen.getByTestId(DIALOG_HEADER_TEST_ID));
    ...
    describe('touch events', () => {
      ...
      it('the component should handle "touchcancel" event', () => {
        ...
        fireEvent.touchCancel(screen.getByTestId(DIALOG_HEADER_TEST_ID));
      ...
      it('the component should handle "touchend" event', () => {
        ...
        fireEvent.touchEnd(screen.getByTestId(DIALOG_HEADER_TEST_ID));
      ...
      it('the component should handle "touchmove" event', () => {
        ...
        fireEvent.touchMove(screen.getByTestId(DIALOG_HEADER_TEST_ID));
      ...
      it('the component should handle "touchstart" event', () => {
        ...
        fireEvent.touchStart(screen.getByTestId(DIALOG_HEADER_TEST_ID));
    ...
    describe('pointer events', () => {
      ...
      it('the component should handle "pointercancel" event', () => {
        ...
        fireEvent.pointerCancel(screen.getByTestId(DIALOG_HEADER_TEST_ID));
      ...
      it('the component should handle "pointerdown" event', () => {
        ...
        fireEvent.pointerDown(screen.getByTestId(DIALOG_HEADER_TEST_ID));
      ...
      it('the component should handle "pointerenter" event', () => {
        ...
        fireEvent.pointerEnter(screen.getByTestId(DIALOG_HEADER_TEST_ID));
      ...
      it('the component should handle "pointerleave" event', () => {
        ...
        fireEvent.pointerLeave(screen.getByTestId(DIALOG_HEADER_TEST_ID));
      ...
      it('the component should handle "pointermove" event', () => {
        ...
        fireEvent.pointerMove(screen.getByTestId(DIALOG_HEADER_TEST_ID));
      ...
      it('the component should handle "pointerout" event', () => {
        ...
        fireEvent.pointerOut(screen.getByTestId(DIALOG_HEADER_TEST_ID));
      ...
      it('the component should handle "pointerover" event', () => {
        ...
        fireEvent.pointerOver(screen.getByTestId(DIALOG_HEADER_TEST_ID));
      ...
      it('the component should handle "pointerup" event', () => {
        ...
        fireEvent.pointerUp(screen.getByTestId(DIALOG_HEADER_TEST_ID));
  ...
  describe('accessibility', () => {
    ...
    describe('the component should render with the correct accessible role', () => {
      ...
      it('renders correctly with default accessible role', () => {
        ...
        expect(screen.getByTestId(DIALOG_HEADER_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(DIALOG_HEADER_TEST_ID)).toHaveRole('banner');
      });

      it('renders correctly with accessible role', () => {
        const role: DialogHeaderProps['role'] = 'none';
        render(
          <DialogHeader
            data-testid={DIALOG_HEADER_TEST_ID}
            role={role}
        ...
        expect(screen.getByTestId(DIALOG_HEADER_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(DIALOG_HEADER_TEST_ID)).toHaveRole(role);
      });
    ...
    describe('the component should render with the correct accessible name', () => {
      ...
      it('renders correctly without accessible name', () => {
        ...
        expect(screen.getByTestId(DIALOG_HEADER_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(DIALOG_HEADER_TEST_ID)).not.toHaveAccessibleName();
      });

      it('renders correctly with accessible name', () => {
        const ariaLabel: DialogHeaderProps['aria-label'] = 'dialog-header';
        render(
          <DialogHeader
            data-testid={DIALOG_HEADER_TEST_ID}
        ...
        expect(screen.getByTestId(DIALOG_HEADER_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(DIALOG_HEADER_TEST_ID)).toHaveAccessibleName(ariaLabel);
      });
