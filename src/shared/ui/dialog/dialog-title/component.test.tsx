...
describe('shared/ui/dialog/dialog-title', () => {
  ...
  describe('properties', () => {
    ...
    describe('the component should render with the correct "children"', () => {
      ...
      it('renders correctly without "children"', () => {
        render(
          <DialogTitle data-testid={DIALOG_HEADER_TEST_ID}  />,
          RENDER_OPTIONS
        );
    ...
    describe('the component should render with the correct "className"', () => {
      ...
      it('renders correctly without "className"', () => {
        ...
        expect(screen.getByTestId(DIALOG_HEADER_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(DIALOG_HEADER_TEST_ID)).toHaveClass(HeadingClasses['heading']);
      });
      ...
      it('renders correctly with single "className"', () => {
        ...
        expect(screen.getByTestId(DIALOG_HEADER_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(DIALOG_HEADER_TEST_ID)).toHaveClass(HeadingClasses['heading'], className1);
      });
      ...
      it('renders correctly with multiple "className"', () => {
        ...
        expect(screen.getByTestId(DIALOG_HEADER_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(DIALOG_HEADER_TEST_ID)).toHaveClass(HeadingClasses['heading'], className1, className2);
      });
  ...
  describe('accessibility', () => {
    ...
    describe('the component should render with the correct accessible role', () => {
      ...
      it('renders correctly with default accessible role', () => {
        ...
        expect(screen.getByTestId(DIALOG_HEADER_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(DIALOG_HEADER_TEST_ID)).toHaveRole('heading');
      });

      it('renders correctly with accessible role', () => {
        const role: DialogTitleProps['role'] = 'none';
        render(
          <DialogTitle
            data-testid={DIALOG_HEADER_TEST_ID}
            role={role}
    ...
    describe('the component should render with the correct accessible name', () => {
      ...
      it('renders correctly with accessible name', () => {
        const ariaLabel: DialogTitleProps['aria-label'] = 'dialog-title';
        render(
          <DialogTitle
            data-testid={DIALOG_HEADER_TEST_ID}
