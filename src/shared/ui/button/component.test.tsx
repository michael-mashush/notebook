  ...
  describe('properties', () => {
    ...
    describe('the component should render with the correct "autoFocus"', () => {
      ...
      it('renders correctly without "authFocus"', () => {
        render(
          <Button data-testid={BUTTON_TEST_ID} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).not.toHaveFocus();
      });

      it('renders correctly with "autoFocus" equal to "false"', () => {
        render(
          <Button data-testid={BUTTON_TEST_ID} autoFocus={false} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).not.toHaveFocus();
      ...
      it('renders correctly with "autoFocus" equal to "true"', () => {
        render(
          <Button data-testid={BUTTON_TEST_ID} autoFocus={true} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveFocus();
      });
    ...
    describe('the component should render with the correct "children"', () => {
      ...
      it('renders correctly without "children"', () => {
        ...
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeEmptyDOMElement();
      });

      it('renders correctly with "children"', () => {
        const textContent = 'button text';
        render(
          <Button data-testid={BUTTON_TEST_ID} children={textContent} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).not.toBeEmptyDOMElement();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveTextContent(textContent);
      });
    ...
    describe('the component should render with the correct "className"', () => {
      ...
      it('renders correctly without "className"', () => {
        ...
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveClass(ButtonClasses['button']);
      });

      it('renders correctly with single "className"', () => {
        const className1 = v4();
        render(
          <Button data-testid={BUTTON_TEST_ID} className={className1} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveClass(ButtonClasses['button'], className1);
      });
      ...
      it('renders correctly with multiple "className"', () => {
        ...
        const className2 = v4();
        render(
          <Button data-testid={BUTTON_TEST_ID} className={`${className1} ${className2}`} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveClass(ButtonClasses['button'], className1, className2);
      });
    ...
    describe('the component should render with the correct "disabled"', () => {
      ...
      it('renders correctly without "disabled"', () => {
        ...
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).not.toBeDisabled();
      });

      it('renders correctly with "disabled" equal to "false"', () => {
        render(
          <Button data-testid={BUTTON_TEST_ID} disabled={false} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).not.toBeDisabled();
      ...
      it('renders correctly with "disabled" equal to "true"', () => {
        render(
          <Button data-testid={BUTTON_TEST_ID} disabled={true} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
    ...
    describe('the component should render with the correct "endIcon"', () => {
      ...
      it('renders correctly with "endIcon"', () => {
        render(
          <Button data-testid={BUTTON_TEST_ID} endIcon={StarIcon} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).not.toBeEmptyDOMElement();
        expect(screen.getByTestId(BUTTON_TEST_ID).querySelector('svg')).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID).querySelector('svg')).toHaveClass('lucide-star');
      });
    ...
    describe('the component should render with the correct "fullWidth"', () => {
      ...
      it('renders correctly without "fullWidth"', () => {
        ...
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).not.toHaveClass(ButtonClasses['button--full-width']);
      });

      it('renders correctly with "fullWidth" equal to "false"', () => {
        render(
          <Button data-testid={BUTTON_TEST_ID} fullWidth={false} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).not.toHaveClass(ButtonClasses['button--full-width']);
      ...
      it('renders correctly with "fullWidth" equal to "true"', () => {
        render(
          <Button data-testid={BUTTON_TEST_ID} fullWidth={true} />,
          RENDER_OPTIONS
        );
        screen.debug();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveClass(ButtonClasses['button--full-width']);
      });
    ...
    describe('the component should render with the correct "justify"', () => {
      ...
      it('renders correctly with default "justify"', () => {
        ...
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveClass(ButtonClasses['button--justify-center']);
      });

      it('renders correctly with "justify" equal to "start"', () => {
        render(
          <Button data-testid={BUTTON_TEST_ID} justify="start" />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveClass(ButtonClasses['button--justify-start']);
      });

      it('renders correctly with "justify" equal to "center"', () => {
        render(
          <Button data-testid={BUTTON_TEST_ID} justify="center" />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveClass(ButtonClasses['button--justify-center']);
      ...
      it('renders correctly with "justify" equal to "end"', () => {
        render(
          <Button data-testid={BUTTON_TEST_ID} justify="end" />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveClass(ButtonClasses['button--justify-end']);
      });
    ...
    describe('the component should render with the correct "loading"', () => {
      ...
      it('renders correctly without "loading"', () => {
        ...
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).not.toBeDisabled();
        expect(screen.getByTestId(BUTTON_TEST_ID)).not.toHaveClass(ButtonClasses['button--loading']);
        expect(screen.getByTestId(BUTTON_TEST_ID).querySelector(`.${ButtonClasses['button-loader']}`)).not.toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID).querySelector('svg')).not.toBeInTheDocument();
      });

      it('renders correctly with "loading" equal to "false"', () => {
        render(
          <Button data-testid={BUTTON_TEST_ID} loading={false} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).not.toBeDisabled();
      ...
      it('renders correctly with "loading" equal to "true"', () => {
        render(
          <Button data-testid={BUTTON_TEST_ID} loading={true} />,
          RENDER_OPTIONS
        );
        screen.debug();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeDisabled();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveClass(ButtonClasses['button--loading']);
        expect(screen.getByTestId(BUTTON_TEST_ID).querySelector(`.${ButtonClasses['button-loader']}`)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID).querySelector('svg')).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID).querySelector('svg')).toHaveClass('lucide', 'lucide-loader-circle');
      });
    ...
    describe('the component should render with the correct "name"', () => {
      ...
      it('renders correctly without "name"', () => {
        ...
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).not.toHaveAttribute('name');
      });

      it('renders correctly with "name"', () => {
        const name = 'button text';
        render(
          <Button data-testid={BUTTON_TEST_ID} name={name} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveAttribute('name', name);
      });
    ...
    describe('the component should render with the correct "onlyIcon"', () => {
      ...
      it('renders correctly with default "onlyIcon"', () => {
        ...
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).not.toHaveClass(ButtonClasses['button--only-icon']);
      });

      it('renders correctly with "onlyIcon" equal to "false"', () => {
        render(
          <Button data-testid={BUTTON_TEST_ID} onlyIcon={false} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).not.toHaveClass(ButtonClasses['button--only-icon']);
      ...
      it('renders correctly with "onlyIcon" equal to "true"', () => {
        render(
          <Button data-testid={BUTTON_TEST_ID} onlyIcon={true} />,
          RENDER_OPTIONS
        );
        screen.debug();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveClass(ButtonClasses['button--only-icon']);
      });
    ...
    describe('the component should render with the correct "size"', () => {
      ...
      it('renders correctly with default "size"', () => {
        ...
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveClass(ButtonClasses['button--size-medium']);
      });

      it('renders correctly with "size" equal to "small"', () => {
        render(
          <Button data-testid={BUTTON_TEST_ID} size="small" />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveClass(ButtonClasses['button--size-small']);
      });

      it('renders correctly with "size" equal to "medium"', () => {
        render(
          <Button data-testid={BUTTON_TEST_ID} size="medium" />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveClass(ButtonClasses['button--size-medium']);
      ...
      it('renders correctly with "size" equal to "large"', () => {
        render(
          <Button data-testid={BUTTON_TEST_ID} size="large" />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveClass(ButtonClasses['button--size-large']);
      });
    ...
    describe('the component should render with the correct "startIcon"', () => {
      ...
      it('renders correctly with "startIcon"', () => {
        render(
          <Button data-testid={BUTTON_TEST_ID} startIcon={InfoIcon} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).not.toBeEmptyDOMElement();
        expect(screen.getByTestId(BUTTON_TEST_ID).querySelector('svg')).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID).querySelector('svg')).toHaveClass('lucide-info');
      });
    ...
    describe('the component should render with the correct "type"', () => {
      ...
      it('renders correctly with default "type"', () => {
        ...
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveAttribute('type', 'button');
      });

      it('renders correctly with "type" equal to "button"', () => {
        render(
          <Button data-testid={BUTTON_TEST_ID} type="button" />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveAttribute('type', 'button');
      ...
      it('renders correctly with "type" equal to "submit"', () => {
        render(
          <Button data-testid={BUTTON_TEST_ID} type="submit" />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveAttribute('type', 'submit');
      });

      it('renders correctly with "type" equal to "reset"', () => {
        render(
          <Button data-testid={BUTTON_TEST_ID} type="reset" />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveAttribute('type', 'reset');
      });
    ...
    describe('the component should render with the correct "variant"', () => {
      ...
      it('renders correctly with default "variant"', () => {
        ...
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveClass(ButtonClasses['button--variant-primary']);
      });

      it('renders correctly with "variant" equal to "primary"', () => {
        render(
          <Button data-testid={BUTTON_TEST_ID} variant="primary" />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveClass(ButtonClasses['button--variant-primary']);
      ...
      it('renders correctly with "variant" equal to "secondary"', () => {
        render(
          <Button data-testid={BUTTON_TEST_ID} variant="secondary" />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveClass(ButtonClasses['button--variant-secondary']);
      });

      it('renders correctly with "variant" equal to "outlined"', () => {
        render(
          <Button data-testid={BUTTON_TEST_ID} variant="outlined" />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveClass(ButtonClasses['button--variant-outlined']);
      });

      it('renders correctly with "variant" equal to "ghost"', () => {
        render(
          <Button data-testid={BUTTON_TEST_ID} variant="ghost" />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveClass(ButtonClasses['button--variant-ghost']);
      });

      it('renders correctly with "variant" equal to "destructive"', () => {
        render(
          <Button data-testid={BUTTON_TEST_ID} variant="destructive" />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveClass(ButtonClasses['button--variant-destructive']);
      });
  ...
  describe('event handling', () => {
    ...
    describe('form events', () => {
      ...
      it('the component should handle "blur" event', () => {
        ...
        fireEvent.blur(screen.getByTestId(BUTTON_TEST_ID));
      ...
      it('the component should handle "focus" event', () => {
        ...
        fireEvent.focus(screen.getByTestId(BUTTON_TEST_ID));
    ...
    describe('keyboard events', () => {
      ...
      it('the component should handle "keydown" event', () => {
        ...
        fireEvent.keyDown(screen.getByTestId(BUTTON_TEST_ID));
      ...
      it('the component should handle "keyup" event', () => {
        ...
        fireEvent.keyUp(screen.getByTestId(BUTTON_TEST_ID));
    ...
    describe('mouse events', () => {
      ...
      it('the component should handle "doubleclick" event', () => {
        ...
        fireEvent.doubleClick(screen.getByTestId(BUTTON_TEST_ID));
      ...
      it('the component should handle "mousedown" event', () => {
        ...
        fireEvent.mouseDown(screen.getByTestId(BUTTON_TEST_ID));
      ...
      it('the component should handle "mouseenter" event', () => {
        ...
        fireEvent.mouseEnter(screen.getByTestId(BUTTON_TEST_ID));
      ...
      it('the component should handle "mouseleave" event', () => {
        ...
        fireEvent.mouseLeave(screen.getByTestId(BUTTON_TEST_ID));
      ...
      it('the component should handle "mousemove" event', () => {
        ...
        fireEvent.mouseMove(screen.getByTestId(BUTTON_TEST_ID));
      ...
      it('the component should handle "mouseout" event', () => {
        ...
        fireEvent.mouseOut(screen.getByTestId(BUTTON_TEST_ID));
      ...
      it('the component should handle "mouseover" event', () => {
        ...
        fireEvent.mouseOver(screen.getByTestId(BUTTON_TEST_ID));
      ...
      it('the component should handle "mouseup" event', () => {
        ...
        fireEvent.mouseUp(screen.getByTestId(BUTTON_TEST_ID));
      ...
      it('the component should handle "wheel" event', () => {
        ...
        fireEvent.wheel(screen.getByTestId(BUTTON_TEST_ID));
    ...
    describe('touch events', () => {
      ...
      it('the component should handle "touchcancel" event', () => {
        ...
        fireEvent.touchCancel(screen.getByTestId(BUTTON_TEST_ID));
      ...
      it('the component should handle "touchend" event', () => {
        ...
        fireEvent.touchEnd(screen.getByTestId(BUTTON_TEST_ID));
      ...
      it('the component should handle "touchmove" event', () => {
        ...
        fireEvent.touchMove(screen.getByTestId(BUTTON_TEST_ID));
      ...
      it('the component should handle "touchstart" event', () => {
        ...
        fireEvent.touchStart(screen.getByTestId(BUTTON_TEST_ID));
    ...
    describe('pointer events', () => {
      ...
      it('the component should handle "pointercancel" event', () => {
        ...
        fireEvent.pointerCancel(screen.getByTestId(BUTTON_TEST_ID));
      ...
      it('the component should handle "pointerdown" event', () => {
        ...
        fireEvent.pointerDown(screen.getByTestId(BUTTON_TEST_ID));
      ...
      it('the component should handle "pointerenter" event', () => {
        ...
        fireEvent.pointerEnter(screen.getByTestId(BUTTON_TEST_ID));
      ...
      it('the component should handle "pointerleave" event', () => {
        ...
        fireEvent.pointerLeave(screen.getByTestId(BUTTON_TEST_ID));
      ...
      it('the component should handle "pointermove" event', () => {
        ...
        fireEvent.pointerMove(screen.getByTestId(BUTTON_TEST_ID));
      ...
      it('the component should handle "pointerout" event', () => {
        ...
        fireEvent.pointerOut(screen.getByTestId(BUTTON_TEST_ID));
      ...
      it('the component should handle "pointerover" event', () => {
        ...
        fireEvent.pointerOver(screen.getByTestId(BUTTON_TEST_ID));
      ...
      it('the component should handle "pointerup" event', () => {
        ...
        fireEvent.pointerUp(screen.getByTestId(BUTTON_TEST_ID));
  ...
  describe('accessibility', () => {
    ...
    describe('the component should render with the correct accessible role', () => {
      ...
      it('renders correctly with default accessible role', () => {
        ...
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveRole('button');
      });

      it('renders correctly with accessible role', () => {
        const role: ButtonProps['role'] = 'none';
        render(
          <Button data-testid={BUTTON_TEST_ID} role={role} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveRole(role);
      });
    ...
    describe('the component should render with the correct accessible name', () => {
      ...
      it('renders correctly without accessible name', () => {
        ...
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).not.toHaveAccessibleName();
      });

      it('renders correctly with accessible name (attribute)', () => {
        const ariaLabel: ButtonProps['aria-label'] = 'button';
        render(
          <Button data-testid={BUTTON_TEST_ID} aria-label={ariaLabel} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveAccessibleName(ariaLabel);
      });

      it('renders correctly with accessible name (children)', () => {
        const children: ButtonProps['children'] = 'button';
        render(
          <Button data-testid={BUTTON_TEST_ID} children={children} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(BUTTON_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(BUTTON_TEST_ID)).toHaveAccessibleName(children);
      });
