...
import TestImage from 'tests/ui/images/test.jpg';

import {
  v4
} from 'uuid';

const AVATAR_FILEBOX_TEST_ID = v4();

describe('shared/ui/avatar-filebox', () => {
  ...
  describe('properties', () => {
    ...
    describe('the component should render with the correct "autoFocus"', () => {
      ...
      it('renders correctly without "authFocus"', () => {
        render(
          <AvatarFilebox data-testid={AVATAR_FILEBOX_TEST_ID} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).not.toHaveFocus();
      });

      it('renders correctly with "autoFocus" equal to "false"', () => {
        render(
          <AvatarFilebox data-testid={AVATAR_FILEBOX_TEST_ID} autoFocus={false} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).not.toHaveFocus();
      ...
      it('renders correctly with "autoFocus" equal to "true"', () => {
        render(
          <AvatarFilebox data-testid={AVATAR_FILEBOX_TEST_ID} autoFocus={true} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toHaveFocus();
      });
    ...
    describe('the component should render with the correct "className"', () => {
      ...
      it('renders correctly without "className"', () => {
        ...
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toHaveClass(AvatarFileboxClasses['avatar-filebox-input']);
      });

      it('renders correctly with single "className"', () => {
        const className1 = v4();
        render(
          <AvatarFilebox data-testid={AVATAR_FILEBOX_TEST_ID} className={className1} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toHaveClass(AvatarFileboxClasses['avatar-filebox-input'], className1);
      });
      ...
      it('renders correctly with multiple "className"', () => {
        ...
        const className2 = v4();
        render(
          <AvatarFilebox data-testid={AVATAR_FILEBOX_TEST_ID} className={`${className1} ${className2}`} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toHaveClass(AvatarFileboxClasses['avatar-filebox-input'], className1, className2);
      });
    ...
    describe('the component should render with the correct "disabled"', () => {
      ...
      it('renders correctly without "disabled"', () => {
        ...
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).not.toBeDisabled();
      });

      it('renders correctly with "disabled" equal to "false"', () => {
        render(
          <AvatarFilebox data-testid={AVATAR_FILEBOX_TEST_ID} disabled={false} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).not.toBeDisabled();
      ...
      it('renders correctly with "disabled" equal to "true"', () => {
        render(
          <AvatarFilebox data-testid={AVATAR_FILEBOX_TEST_ID} disabled={true} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toBeDisabled();
      });
    ...
    describe('the component should render with the correct "name"', () => {
      ...
      it('renders correctly without "name"', () => {
        ...
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).not.toHaveAttribute('name');
      });

      it('renders correctly with "name"', () => {
        const name = 'button text';
        render(
          <AvatarFilebox data-testid={AVATAR_FILEBOX_TEST_ID} name={name} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toHaveAttribute('name', name);
      });

    });

    describe('the component should render with the correct "preview"', () => {

      it('renders correctly without "preview"', () => {
        render(
          <AvatarFilebox data-testid={AVATAR_FILEBOX_TEST_ID} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID).nextElementSibling?.querySelector('img')).not.toBeInTheDocument();
      });

      it('renders correctly with "preview"', () => {
        const preview = TestImage;
        render(
          <AvatarFilebox data-testid={AVATAR_FILEBOX_TEST_ID} preview={preview} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID).nextElementSibling?.querySelector('img')).toBeInTheDocument();
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID).nextElementSibling?.querySelector('img')).toHaveAttribute('src', preview);
      });
  ...
  describe('event handling', () => {
    ...
    describe('form events', () => {
      ...
      it('the component should handle "blur" event', () => {
        ...
        render(
          <AvatarFilebox
            data-testid={AVATAR_FILEBOX_TEST_ID}
        ...
        fireEvent.blur(screen.getByTestId(AVATAR_FILEBOX_TEST_ID));
      ...
      it('the component should handle "focus" event', () => {
        ...
        fireEvent.focus(screen.getByTestId(AVATAR_FILEBOX_TEST_ID));
      ...
      it('the component should handle "change" event', () => {
        ...
        fireEvent.change(screen.getByTestId(AVATAR_FILEBOX_TEST_ID));
      ...
      it('the component should handle "invalid" event', () => {
        ...
        fireEvent.invalid(screen.getByTestId(AVATAR_FILEBOX_TEST_ID));
    ...
    describe('keyboard events', () => {
      ...
      it('the component should handle "keydown" event', () => {
        ...
        fireEvent.keyDown(screen.getByTestId(AVATAR_FILEBOX_TEST_ID));
      ...
      it('the component should handle "keyup" event', () => {
        ...
        fireEvent.keyUp(screen.getByTestId(AVATAR_FILEBOX_TEST_ID));
    ...
    describe('mouse events', () => {
      ...
      it('the component should handle "click" event', () => {
        ...
        fireEvent.click(screen.getByTestId(AVATAR_FILEBOX_TEST_ID));
      ...
      it('the component should handle "doubleclick" event', () => {
        ...
        fireEvent.doubleClick(screen.getByTestId(AVATAR_FILEBOX_TEST_ID));
      ...
      it('the component should handle "mousedown" event', () => {
        ...
        fireEvent.mouseDown(screen.getByTestId(AVATAR_FILEBOX_TEST_ID));
      ...
      it('the component should handle "mouseenter" event', () => {
        ...
        fireEvent.mouseEnter(screen.getByTestId(AVATAR_FILEBOX_TEST_ID));
      ...
      it('the component should handle "mouseleave" event', () => {
        ...
        fireEvent.mouseLeave(screen.getByTestId(AVATAR_FILEBOX_TEST_ID));
      ...
      it('the component should handle "mousemove" event', () => {
        ...
        fireEvent.mouseMove(screen.getByTestId(AVATAR_FILEBOX_TEST_ID));
      ...
      it('the component should handle "mouseout" event', () => {
        ...
        fireEvent.mouseOut(screen.getByTestId(AVATAR_FILEBOX_TEST_ID));
      ...
      it('the component should handle "mouseover" event', () => {
        ...
        fireEvent.mouseOver(screen.getByTestId(AVATAR_FILEBOX_TEST_ID));
      ...
      it('the component should handle "mouseup" event', () => {
        ...
        fireEvent.mouseUp(screen.getByTestId(AVATAR_FILEBOX_TEST_ID));
      ...
      it('the component should handle "wheel" event', () => {
        ...
        fireEvent.wheel(screen.getByTestId(AVATAR_FILEBOX_TEST_ID));
    ...
    describe('touch events', () => {
      ...
      it('the component should handle "touchcancel" event', () => {
        ...
        fireEvent.touchCancel(screen.getByTestId(AVATAR_FILEBOX_TEST_ID));
      ...
      it('the component should handle "touchend" event', () => {
        ...
        fireEvent.touchEnd(screen.getByTestId(AVATAR_FILEBOX_TEST_ID));
      ...
      it('the component should handle "touchmove" event', () => {
        ...
        fireEvent.touchMove(screen.getByTestId(AVATAR_FILEBOX_TEST_ID));
      ...
      it('the component should handle "touchstart" event', () => {
        ...
        fireEvent.touchStart(screen.getByTestId(AVATAR_FILEBOX_TEST_ID));
    ...
    describe('pointer events', () => {
      ...
      it('the component should handle "pointercancel" event', () => {
        ...
        fireEvent.pointerCancel(screen.getByTestId(AVATAR_FILEBOX_TEST_ID));
      ...
      it('the component should handle "pointerdown" event', () => {
        ...
        fireEvent.pointerDown(screen.getByTestId(AVATAR_FILEBOX_TEST_ID));
      ...
      it('the component should handle "pointerenter" event', () => {
        ...
        fireEvent.pointerEnter(screen.getByTestId(AVATAR_FILEBOX_TEST_ID));
      ...
      it('the component should handle "pointerleave" event', () => {
        ...
        fireEvent.pointerLeave(screen.getByTestId(AVATAR_FILEBOX_TEST_ID));
      ...
      it('the component should handle "pointermove" event', () => {
        ...
        fireEvent.pointerMove(screen.getByTestId(AVATAR_FILEBOX_TEST_ID));
      ...
      it('the component should handle "pointerout" event', () => {
        ...
        fireEvent.pointerOut(screen.getByTestId(AVATAR_FILEBOX_TEST_ID));
      ...
      it('the component should handle "pointerover" event', () => {
        ...
        fireEvent.pointerOver(screen.getByTestId(AVATAR_FILEBOX_TEST_ID));
      ...
      it('the component should handle "pointerup" event', () => {
        ...
        fireEvent.pointerUp(screen.getByTestId(AVATAR_FILEBOX_TEST_ID));
  ...
  describe('accessibility', () => {
    ...
    describe('the component should render with the correct accessible role', () => {
      ...
      it('renders correctly with default accessible role', () => {
        ...
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toHaveRole('button');
      });

      it('renders correctly with accessible role', () => {
        const role: AvatarFileboxProps['role'] = 'none';
        render(
          <AvatarFilebox data-testid={AVATAR_FILEBOX_TEST_ID} role={role} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toHaveRole(role);
      });
    ...
    describe('the component should render with the correct accessible name', () => {
      ...
      it('renders correctly without accessible name', () => {
        ...
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toHaveAccessibleName('avatar-picker');
      });

      it('renders correctly with accessible name', () => {
        const ariaLabel: AvatarFileboxProps['aria-label'] = 'user-avatar-picker';
        render(
          <AvatarFilebox data-testid={AVATAR_FILEBOX_TEST_ID} aria-label={ariaLabel} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toHaveAccessibleName(ariaLabel);
      });
    ...
    describe('the component should render with the correct accessible description', () => {
      ...
      it('renders correctly without accessible description', () => {
        ...
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).not.toHaveAccessibleDescription();
      });

      it('renders correctly with accessible description', () => {
        const ariaDescription: AvatarFileboxProps['aria-description'] = 'button';
        render(
          <AvatarFilebox data-testid={AVATAR_FILEBOX_TEST_ID} aria-description={ariaDescription} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toHaveAccessibleDescription(ariaDescription);
      });
    ...
    describe('the component should render with the correct accessible error message', () => {
      ...
      it('renders correctly without accessible error message', () => {
        ...
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).not.toHaveAccessibleErrorMessage();
      });

      it('renders correctly with accessible error message', () => {
        const errorMessageId: AvatarFileboxProps['aria-errormessage'] = 'message-id';
        render(
          <Fragment>
            <AvatarFilebox
              data-testid={AVATAR_FILEBOX_TEST_ID}
        ...
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(AVATAR_FILEBOX_TEST_ID)).toHaveAccessibleErrorMessage(screen.getByTestId(errorMessageId).textContent);
      });
