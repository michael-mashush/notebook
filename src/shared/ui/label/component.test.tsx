...
const LABEL_TEST_ID = v4();

describe('shared/ui/label', () => {
  ...
  describe('properties', () => {
    ...
    describe('the component should render with the correct "children"', () => {
      ...
      it('renders correctly without "children"', () => {
        render(
          <Label data-testid={LABEL_TEST_ID} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(LABEL_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(LABEL_TEST_ID)).toHaveTextContent('');
      });
      ...
      it('renders correctly with "children"', () => {
        ...
        expect(screen.getByTestId(LABEL_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(LABEL_TEST_ID)).toHaveTextContent(children);
      });
    ...
    describe('the component should render with the correct "className"', () => {
      ...
      it('renders correctly without "className"', () => {
        ...
        expect(screen.getByTestId(LABEL_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(LABEL_TEST_ID)).toHaveClass(LabelClasses['label']);
      });
      ...
      it('renders correctly with single "className"', () => {
        ...
        expect(screen.getByTestId(LABEL_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(LABEL_TEST_ID)).toHaveClass(LabelClasses['label'], className1);
      });
      ...
      it('renders correctly with multiple "className"', () => {
        ...
        expect(screen.getByTestId(LABEL_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(LABEL_TEST_ID)).toHaveClass(LabelClasses['label'], className1, className2);
      });
    ...
    describe('the component should render with the correct "htmlFor"', () => {
      ...
      it('renders correctly without "htmlFor"', () => {
        ...
        expect(screen.getByTestId(LABEL_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(LABEL_TEST_ID)).not.toHaveAttribute('for');
      });
      ...
      it('renders correctly with "htmlFor"', () => {
        ...
        expect(screen.getByTestId(LABEL_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(LABEL_TEST_ID)).toHaveAttribute('for', id);
      });
  ...
  describe('event handling', () => {
    ...
    describe('keyboard events', () => {
      ...
      it('the component should handle "keydown" event', () => {
        ...
        fireEvent.keyDown(screen.getByTestId(LABEL_TEST_ID));
      ...
      it('the component should handle "keyup" event', () => {
        ...
        fireEvent.keyUp(screen.getByTestId(LABEL_TEST_ID));
    ...
    describe('mouse events', () => {
      ...
      it('the component should handle "click" event', () => {
        ...
        fireEvent.click(screen.getByTestId(LABEL_TEST_ID));
      ...
      it('the component should handle "doubleclick" event', () => {
        ...
        fireEvent.doubleClick(screen.getByTestId(LABEL_TEST_ID));
      ...
      it('the component should handle "mousedown" event', () => {
        ...
        fireEvent.mouseDown(screen.getByTestId(LABEL_TEST_ID));
      ...
      it('the component should handle "mouseenter" event', () => {
        ...
        fireEvent.mouseEnter(screen.getByTestId(LABEL_TEST_ID));
      ...
      it('the component should handle "mouseleave" event', () => {
        ...
        fireEvent.mouseLeave(screen.getByTestId(LABEL_TEST_ID));
      ...
      it('the component should handle "mousemove" event', () => {
        ...
        fireEvent.mouseMove(screen.getByTestId(LABEL_TEST_ID));
      ...
      it('the component should handle "mouseout" event', () => {
        ...
        fireEvent.mouseOut(screen.getByTestId(LABEL_TEST_ID));
      ...
      it('the component should handle "mouseover" event', () => {
        ...
        fireEvent.mouseOver(screen.getByTestId(LABEL_TEST_ID));
      ...
      it('the component should handle "mouseup" event', () => {
        ...
        fireEvent.mouseUp(screen.getByTestId(LABEL_TEST_ID));
      ...
      it('the component should handle "wheel" event', () => {
        ...
        fireEvent.wheel(screen.getByTestId(LABEL_TEST_ID));
    ...
    describe('touch events', () => {
      ...
      it('the component should handle "touchcancel" event', () => {
        ...
        fireEvent.touchCancel(screen.getByTestId(LABEL_TEST_ID));
      ...
      it('the component should handle "touchend" event', () => {
        ...
        fireEvent.touchEnd(screen.getByTestId(LABEL_TEST_ID));
      ...
      it('the component should handle "touchmove" event', () => {
        ...
        fireEvent.touchMove(screen.getByTestId(LABEL_TEST_ID));
      ...
      it('the component should handle "touchstart" event', () => {
        ...
        fireEvent.touchStart(screen.getByTestId(LABEL_TEST_ID));
    ...
    describe('pointer events', () => {
      ...
      it('the component should handle "pointercancel" event', () => {
        ...
        fireEvent.pointerCancel(screen.getByTestId(LABEL_TEST_ID));
      ...
      it('the component should handle "pointerdown" event', () => {
        ...
        fireEvent.pointerDown(screen.getByTestId(LABEL_TEST_ID));
      ...
      it('the component should handle "pointerenter" event', () => {
        ...
        fireEvent.pointerEnter(screen.getByTestId(LABEL_TEST_ID));
      ...
      it('the component should handle "pointerleave" event', () => {
        ...
        fireEvent.pointerLeave(screen.getByTestId(LABEL_TEST_ID));
      ...
      it('the component should handle "pointermove" event', () => {
        ...
        fireEvent.pointerMove(screen.getByTestId(LABEL_TEST_ID));
      ...
      it('the component should handle "pointerout" event', () => {
        ...
        fireEvent.pointerOut(screen.getByTestId(LABEL_TEST_ID));
      ...
      it('the component should handle "pointerover" event', () => {
        ...
        fireEvent.pointerOver(screen.getByTestId(LABEL_TEST_ID));
      ...
      it('the component should handle "pointerup" event', () => {
        ...
        fireEvent.pointerUp(screen.getByTestId(LABEL_TEST_ID));
  ...
  describe('accessibility', () => {
    ...
    describe('the component should render with the correct accessible role', () => {
      ...
      it('renders correctly with default accessible role', () => {
        ...
        expect(screen.getByTestId(LABEL_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(LABEL_TEST_ID)).not.toHaveRole('');
      });

      it('renders correctly with accessible role', () => {
        const role: LabelProps['role'] = 'none';
        render(
          <Label
            data-testid={LABEL_TEST_ID}
            role={role}
        ...
        expect(screen.getByTestId(LABEL_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(LABEL_TEST_ID)).toHaveRole(role);
      });
    ...
    describe('the component should render with the correct accessible name', () => {
      ...
      it('renders correctly without accessible name', () => {
        ...
        expect(screen.getByTestId(LABEL_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(LABEL_TEST_ID)).not.toHaveAccessibleName();
      });

      it('renders correctly with accessible name', () => {
        const ariaLabel: LabelProps['aria-label'] = 'label';
        render(
          <Label
            data-testid={LABEL_TEST_ID}
        ...
        expect(screen.getByTestId(LABEL_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(LABEL_TEST_ID)).toHaveAccessibleName(ariaLabel);
      });
