  ...
  describe('properties', () => {
    ...
    describe('the component should render with the correct "autoFocus"', () => {
      ...
      it('renders correctly without "authFocus"', () => {
        render(
          <Switch data-testid={SWITCH_TEST_ID} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(SWITCH_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SWITCH_TEST_ID)).not.toHaveFocus();
      });

      it('renders correctly with "autoFocus" equal to "false"', () => {
        render(
          <Switch data-testid={SWITCH_TEST_ID} autoFocus={false} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(SWITCH_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SWITCH_TEST_ID)).not.toHaveFocus();
      ...
      it('renders correctly with "autoFocus" equal to "true"', () => {
        render(
          <Switch data-testid={SWITCH_TEST_ID} autoFocus={true} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(SWITCH_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SWITCH_TEST_ID)).toHaveFocus();
      });
    ...
    describe('the component should render with the correct "checked"', () => {
      ...
      it('renders correctly without "checked"', () => {
        ...
        expect(screen.getByTestId(SWITCH_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SWITCH_TEST_ID)).not.toBeChecked();
      });

      it('renders correctly with "checked" equal to "false"', () => {
        render(
          <Switch data-testid={SWITCH_TEST_ID} checked={false} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(SWITCH_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SWITCH_TEST_ID)).not.toBeChecked();
      ...
      it('renders correctly with "checked" equal to "true"', () => {
        render(
          <Switch data-testid={SWITCH_TEST_ID} checked={true} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(SWITCH_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SWITCH_TEST_ID)).toBeChecked();
      });
    ...
    describe('the component should render with the correct "className"', () => {
      ...
      it('renders correctly without "className"', () => {
        ...
        expect(screen.getByTestId(SWITCH_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SWITCH_TEST_ID)).toHaveClass(SwitchClasses['checkbox']);
      });

      it('renders correctly with single "className"', () => {
        const className1 = v4();
        render(
          <Switch data-testid={SWITCH_TEST_ID} className={className1} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(SWITCH_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SWITCH_TEST_ID)).toHaveClass(SwitchClasses['checkbox'], className1);
      });
      ...
      it('renders correctly with multiple "className"', () => {
        ...
        const className2 = v4();
        render(
          <Switch data-testid={SWITCH_TEST_ID} className={`${className1} ${className2}`} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(SWITCH_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SWITCH_TEST_ID)).toHaveClass(SwitchClasses['checkbox'], className1, className2);
      });
    ...
    describe('the component should render with the correct "defaultChecked"', () => {
      ...
      it('renders correctly with "defaultChecked" equal to "false"', () => {
        render(
          <Switch data-testid={SWITCH_TEST_ID} defaultChecked={false} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(SWITCH_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SWITCH_TEST_ID)).not.toBeChecked();
      ...
      it('renders correctly with "defaultChecked" equal to "true"', () => {
        render(
          <Switch data-testid={SWITCH_TEST_ID} defaultChecked={true} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(SWITCH_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SWITCH_TEST_ID)).toBeChecked();
    ...
    describe('the component should render with the correct "disabled"', () => {
      ...
      it('renders correctly without "disabled"', () => {
        ...
        expect(screen.getByTestId(SWITCH_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SWITCH_TEST_ID)).not.toBeDisabled();
      });

      it('renders correctly with "disabled" equal to "false"', () => {
        render(
          <Switch data-testid={SWITCH_TEST_ID} disabled={false} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(SWITCH_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SWITCH_TEST_ID)).not.toBeDisabled();
      ...
      it('renders correctly with "disabled" equal to "true"', () => {
        render(
          <Switch data-testid={SWITCH_TEST_ID} disabled={true} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(SWITCH_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SWITCH_TEST_ID)).toBeDisabled();
      });
    ...
    describe('the component should render with the correct "name"', () => {
      ...
      it('renders correctly without "name"', () => {
        ...
        expect(screen.getByTestId(SWITCH_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SWITCH_TEST_ID)).not.toHaveAttribute('name');
      });

      it('renders correctly with "name"', () => {
        const name = 'button text';
        render(
          <Switch data-testid={SWITCH_TEST_ID} name={name} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(SWITCH_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SWITCH_TEST_ID)).toHaveAttribute('name', name);
      });
  ...
  describe('event handling', () => {
    ...
    describe('form events', () => {
      ...
      it('the component should handle "blur" event', () => {
        ...
        fireEvent.blur(screen.getByTestId(SWITCH_TEST_ID));
      ...
      it('the component should handle "focus" event', () => {
        ...
        fireEvent.focus(screen.getByTestId(SWITCH_TEST_ID));
      ...
      it('the component should handle "change" event', () => {
        ...
        fireEvent.click(screen.getByTestId(SWITCH_TEST_ID));
      ...
      it('the component should handle "invalid" event', () => {
        ...
        fireEvent.invalid(screen.getByTestId(SWITCH_TEST_ID));
    ...
    describe('keyboard events', () => {
      ...
      it('the component should handle "keydown" event', () => {
        ...
        fireEvent.keyDown(screen.getByTestId(SWITCH_TEST_ID));
      ...
      it('the component should handle "keyup" event', () => {
        ...
        fireEvent.keyUp(screen.getByTestId(SWITCH_TEST_ID));
    ...
    describe('mouse events', () => {
      ...
      it('the component should handle "doubleclick" event', () => {
        ...
        fireEvent.doubleClick(screen.getByTestId(SWITCH_TEST_ID));
      ...
      it('the component should handle "mousedown" event', () => {
        ...
        fireEvent.mouseDown(screen.getByTestId(SWITCH_TEST_ID));
      ...
      it('the component should handle "mouseenter" event', () => {
        ...
        fireEvent.mouseEnter(screen.getByTestId(SWITCH_TEST_ID));
      ...
      it('the component should handle "mouseleave" event', () => {
        ...
        fireEvent.mouseLeave(screen.getByTestId(SWITCH_TEST_ID));
      ...
      it('the component should handle "mousemove" event', () => {
        ...
        fireEvent.mouseMove(screen.getByTestId(SWITCH_TEST_ID));
      ...
      it('the component should handle "mouseout" event', () => {
        ...
        fireEvent.mouseOut(screen.getByTestId(SWITCH_TEST_ID));
      ...
      it('the component should handle "mouseover" event', () => {
        ...
        fireEvent.mouseOver(screen.getByTestId(SWITCH_TEST_ID));
      ...
      it('the component should handle "mouseup" event', () => {
        ...
        fireEvent.mouseUp(screen.getByTestId(SWITCH_TEST_ID));
      ...
      it('the component should handle "wheel" event', () => {
        ...
        fireEvent.wheel(screen.getByTestId(SWITCH_TEST_ID));
    ...
    describe('touch events', () => {
      ...
      it('the component should handle "touchcancel" event', () => {
        ...
        fireEvent.touchCancel(screen.getByTestId(SWITCH_TEST_ID));
      ...
      it('the component should handle "touchend" event', () => {
        ...
        fireEvent.touchEnd(screen.getByTestId(SWITCH_TEST_ID));
      ...
      it('the component should handle "touchmove" event', () => {
        ...
        fireEvent.touchMove(screen.getByTestId(SWITCH_TEST_ID));
      ...
      it('the component should handle "touchstart" event', () => {
        ...
        fireEvent.touchStart(screen.getByTestId(SWITCH_TEST_ID));
    ...
    describe('pointer events', () => {
      ...
      it('the component should handle "pointercancel" event', () => {
        ...
        fireEvent.pointerCancel(screen.getByTestId(SWITCH_TEST_ID));
      ...
      it('the component should handle "pointerdown" event', () => {
        ...
        fireEvent.pointerDown(screen.getByTestId(SWITCH_TEST_ID));
      ...
      it('the component should handle "pointerenter" event', () => {
        ...
        fireEvent.pointerEnter(screen.getByTestId(SWITCH_TEST_ID));
      ...
      it('the component should handle "pointerleave" event', () => {
        ...
        fireEvent.pointerLeave(screen.getByTestId(SWITCH_TEST_ID));
      ...
      it('the component should handle "pointermove" event', () => {
        ...
        fireEvent.pointerMove(screen.getByTestId(SWITCH_TEST_ID));
      ...
      it('the component should handle "pointerout" event', () => {
        ...
        fireEvent.pointerOut(screen.getByTestId(SWITCH_TEST_ID));
      ...
      it('the component should handle "pointerover" event', () => {
        ...
        fireEvent.pointerOver(screen.getByTestId(SWITCH_TEST_ID));
      ...
      it('the component should handle "pointerup" event', () => {
        ...
        fireEvent.pointerUp(screen.getByTestId(SWITCH_TEST_ID));
  ...
  describe('accessibility', () => {
    ...
    describe('the component should render with the correct accessible role', () => {
      ...
      it('renders correctly with default accessible role', () => {
        ...
        expect(screen.getByTestId(SWITCH_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SWITCH_TEST_ID)).toHaveRole('switch');
      });

      it('renders correctly with accessible role', () => {
        const role: SwitchProps['role'] = 'none';
        render(
          <Switch data-testid={SWITCH_TEST_ID} role={role} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(SWITCH_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SWITCH_TEST_ID)).toHaveRole(role);
      });
    ...
    describe('the component should render with the correct accessible name', () => {
      ...
      it('renders correctly without accessible name', () => {
        ...
        expect(screen.getByTestId(SWITCH_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SWITCH_TEST_ID)).not.toHaveAccessibleName();
      });

      it('renders correctly with accessible name', () => {
        const ariaLabel: SwitchProps['aria-label'] = 'switch';
        render(
          <Switch data-testid={SWITCH_TEST_ID} aria-label={ariaLabel} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(SWITCH_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SWITCH_TEST_ID)).toHaveAccessibleName(ariaLabel);
      });
    ...
    describe('the component should render with the correct accessible description', () => {
      ...
      it('renders correctly without accessible description', () => {
        ...
        expect(screen.getByTestId(SWITCH_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SWITCH_TEST_ID)).not.toHaveAccessibleDescription();
      });

      it('renders correctly with accessible description', () => {
        const ariaDescription: SwitchProps['aria-description'] = 'button';
        render(
          <Switch data-testid={SWITCH_TEST_ID} aria-description={ariaDescription} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(SWITCH_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SWITCH_TEST_ID)).toHaveAccessibleDescription(ariaDescription);
      });
    ...
    describe('the component should render with the correct accessible error message', () => {
      ...
      it('renders correctly without accessible error message', () => {
        ...
        expect(screen.getByTestId(SWITCH_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SWITCH_TEST_ID)).not.toHaveAccessibleErrorMessage();
      });

      it('renders correctly with accessible error message', () => {
        const errorMessageId: SwitchProps['aria-errormessage'] = 'message-id';
        render(
          <Fragment>
            <Switch
              data-testid={SWITCH_TEST_ID}
        ...
        expect(screen.getByTestId(SWITCH_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SWITCH_TEST_ID)).toHaveAccessibleErrorMessage(screen.getByTestId(errorMessageId).textContent);
      });
