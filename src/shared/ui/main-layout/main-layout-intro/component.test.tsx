...
import {
  MainLayoutIntro,
  MainLayoutIntroProps,
  MainLayoutIntroClasses
} from 'shared/ui';
...
const MAIN_LAYOUT_INTRO_TEST_ID = v4();

describe('shared/ui/main-layout/main-layout-intro', () => {
  ...
  describe('properties', () => {
    ...
    describe('the component should render with the correct "children"', () => {
      ...
      it('renders correctly without "children"', () => {
        render(
          <MainLayoutIntro data-testid={MAIN_LAYOUT_INTRO_TEST_ID} />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID)).toHaveTextContent('');
      });
      ...
      it('renders correctly with "children"', () => {
        ...
        render(
          <MainLayoutIntro
            data-testid={MAIN_LAYOUT_INTRO_TEST_ID}
            children={children}
          />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID)).toHaveTextContent(children);
      });
    ...
    describe('the component should render with the correct "className"', () => {
      ...
      it('renders correctly without "className"', () => {
        ...
        expect(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID)).toHaveClass(MainLayoutIntroClasses['main-layout-intro']);
      });
      ...
      it('renders correctly with single "className"', () => {
        ...
        expect(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID)).toHaveClass(MainLayoutIntroClasses['main-layout-intro'], className1);
      });
      ...
      it('renders correctly with multiple "className"', () => {
        ...
        expect(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID)).toHaveClass(MainLayoutIntroClasses['main-layout-intro'], className1, className2);
      });
  ...
  describe('event handling', () => {
    ...
    describe('keyboard events', () => {
      ...
      it('the component should handle "keydown" event', () => {
        ...
        fireEvent.keyDown(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID));
      ...
      it('the component should handle "keyup" event', () => {
        ...
        fireEvent.keyUp(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID));
    ...
    describe('mouse events', () => {
      ...
      it('the component should handle "click" event', () => {
        ...
        fireEvent.click(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID));
      ...
      it('the component should handle "doubleclick" event', () => {
        ...
        fireEvent.doubleClick(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID));
      ...
      it('the component should handle "mousedown" event', () => {
        ...
        fireEvent.mouseDown(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID));
      ...
      it('the component should handle "mouseenter" event', () => {
        ...
        fireEvent.mouseEnter(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID));
      ...
      it('the component should handle "mouseleave" event', () => {
        ...
        fireEvent.mouseLeave(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID));
      ...
      it('the component should handle "mousemove" event', () => {
        ...
        fireEvent.mouseMove(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID));
      ...
      it('the component should handle "mouseout" event', () => {
        ...
        fireEvent.mouseOut(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID));
      ...
      it('the component should handle "mouseover" event', () => {
        ...
        fireEvent.mouseOver(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID));
      ...
      it('the component should handle "mouseup" event', () => {
        ...
        fireEvent.mouseUp(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID));
      ...
      it('the component should handle "wheel" event', () => {
        ...
        fireEvent.wheel(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID));
    ...
    describe('touch events', () => {
      ...
      it('the component should handle "touchcancel" event', () => {
        ...
        fireEvent.touchCancel(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID));
      ...
      it('the component should handle "touchend" event', () => {
        ...
        fireEvent.touchEnd(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID));
      ...
      it('the component should handle "touchmove" event', () => {
        ...
        fireEvent.touchMove(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID));
      ...
      it('the component should handle "touchstart" event', () => {
        ...
        fireEvent.touchStart(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID));
    ...
    describe('pointer events', () => {
      ...
      it('the component should handle "pointercancel" event', () => {
        ...
        fireEvent.pointerCancel(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID));
      ...
      it('the component should handle "pointerdown" event', () => {
        ...
        fireEvent.pointerDown(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID));
      ...
      it('the component should handle "pointerenter" event', () => {
        ...
        fireEvent.pointerEnter(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID));
      ...
      it('the component should handle "pointerleave" event', () => {
        ...
        fireEvent.pointerLeave(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID));
      ...
      it('the component should handle "pointermove" event', () => {
        ...
        fireEvent.pointerMove(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID));
      ...
      it('the component should handle "pointerout" event', () => {
        ...
        fireEvent.pointerOut(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID));
      ...
      it('the component should handle "pointerover" event', () => {
        ...
        fireEvent.pointerOver(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID));
      ...
      it('the component should handle "pointerup" event', () => {
        ...
        fireEvent.pointerUp(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID));
  ...
  describe('accessibility', () => {
    ...
    describe('the component should render with the correct accessible role', () => {
      ...
      it('renders correctly with default accessible role', () => {
        ...
        expect(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID)).toHaveRole('generic');
      });

      it('renders correctly with accessible role', () => {
        const role: MainLayoutIntroProps['role'] = 'none';
        render(
          <MainLayoutIntro
            data-testid={MAIN_LAYOUT_INTRO_TEST_ID}
            role={role}
        ...
        expect(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID)).toHaveRole(role);
      });
    ...
    describe('the component should render with the correct accessible name', () => {
      ...
      it('renders correctly without accessible name', () => {
        ...
        expect(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID)).not.toHaveAccessibleName();
      });

      it('renders correctly with accessible name', () => {
        const ariaLabel: MainLayoutIntroProps['aria-label'] = 'main-layout-intro';
        render(
          <MainLayoutIntro
            data-testid={MAIN_LAYOUT_INTRO_TEST_ID}
        ...
        expect(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(MAIN_LAYOUT_INTRO_TEST_ID)).toHaveAccessibleName(ariaLabel);
      });
