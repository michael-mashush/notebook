  ...
  describe('properties', () => {
    ...
    describe('the component should render with the correct "className"', () => {
      ...
      it('renders correctly without "className"', () => {
        ...
        expect(screen.getByTestId(SPINNER_TEST_ID)).toHaveClass(IconClasses['icon']);
      });
      ...
      it('renders correctly with single "className"', () => {
        ...
        expect(screen.getByTestId(SPINNER_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SPINNER_TEST_ID)).toHaveClass(IconClasses['icon'], className1);
      });
      ...
      it('renders correctly with multiple "className"', () => {
        ...
        expect(screen.getByTestId(SPINNER_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SPINNER_TEST_ID)).toHaveClass(IconClasses['icon'], className1, className2);
      });
    ...
    describe('the component should render with the correct "size"', () => {
      ...
      it('renders correctly without "size"', () => {
        ...
        expect(screen.getByTestId(SPINNER_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SPINNER_TEST_ID)).toHaveClass(IconClasses['icon--size-medium']);
      });
      ...
      it('renders correctly with "className" equal to "small"', () => {
        ...
        expect(screen.getByTestId(SPINNER_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SPINNER_TEST_ID)).toHaveClass(IconClasses['icon--size-small']);
      });
      ...
      it('renders correctly with "className" equal to "large"', () => {
        ...
        expect(screen.getByTestId(SPINNER_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SPINNER_TEST_ID)).toHaveClass(IconClasses['icon--size-large']);
      });
    ...
    describe('the component should render with the correct "src"', () => {
      ...
      it('renders correctly with "src"', () => {
        ...
        expect(screen.getByTestId(SPINNER_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SPINNER_TEST_ID)).toHaveClass('lucide-star');
      });
  ...
  describe('event handling', () => {
    ...
    describe('keyboard events', () => {
      ...
      it('the component should handle "keydown" event', () => {
        ...
        fireEvent.keyDown(screen.getByTestId(SPINNER_TEST_ID));
      ...
      it('the component should handle "keyup" event', () => {
        ...
        fireEvent.keyUp(screen.getByTestId(SPINNER_TEST_ID));
    ...
    describe('mouse events', () => {
      ...
      it('the component should handle "click" event', () => {
        ...
        fireEvent.click(screen.getByTestId(SPINNER_TEST_ID));
      ...
      it('the component should handle "doubleclick" event', () => {
        ...
        fireEvent.doubleClick(screen.getByTestId(SPINNER_TEST_ID));
      ...
      it('the component should handle "mousedown" event', () => {
        ...
        fireEvent.mouseDown(screen.getByTestId(SPINNER_TEST_ID));
      ...
      it('the component should handle "mouseenter" event', () => {
        ...
        fireEvent.mouseEnter(screen.getByTestId(SPINNER_TEST_ID));
      ...
      it('the component should handle "mouseleave" event', () => {
        ...
        fireEvent.mouseLeave(screen.getByTestId(SPINNER_TEST_ID));
      ...
      it('the component should handle "mousemove" event', () => {
        ...
        fireEvent.mouseMove(screen.getByTestId(SPINNER_TEST_ID));
      ...
      it('the component should handle "mouseout" event', () => {
        ...
        fireEvent.mouseOut(screen.getByTestId(SPINNER_TEST_ID));
      ...
      it('the component should handle "mouseover" event', () => {
        ...
        fireEvent.mouseOver(screen.getByTestId(SPINNER_TEST_ID));
      ...
      it('the component should handle "mouseup" event', () => {
        ...
        fireEvent.mouseUp(screen.getByTestId(SPINNER_TEST_ID));
      ...
      it('the component should handle "wheel" event', () => {
        ...
        fireEvent.wheel(screen.getByTestId(SPINNER_TEST_ID));
    ...
    describe('touch events', () => {
      ...
      it('the component should handle "touchcancel" event', () => {
        ...
        fireEvent.touchCancel(screen.getByTestId(SPINNER_TEST_ID));
      ...
      it('the component should handle "touchend" event', () => {
        ...
        fireEvent.touchEnd(screen.getByTestId(SPINNER_TEST_ID));
      ...
      it('the component should handle "touchmove" event', () => {
        ...
        fireEvent.touchMove(screen.getByTestId(SPINNER_TEST_ID));
      ...
      it('the component should handle "touchstart" event', () => {
        ...
        fireEvent.touchStart(screen.getByTestId(SPINNER_TEST_ID));
    ...
    describe('pointer events', () => {
      ...
      it('the component should handle "pointercancel" event', () => {
        ...
        fireEvent.pointerCancel(screen.getByTestId(SPINNER_TEST_ID));
      ...
      it('the component should handle "pointerdown" event', () => {
        ...
        fireEvent.pointerDown(screen.getByTestId(SPINNER_TEST_ID));
      ...
      it('the component should handle "pointerenter" event', () => {
        ...
        fireEvent.pointerEnter(screen.getByTestId(SPINNER_TEST_ID));
      ...
      it('the component should handle "pointerleave" event', () => {
        ...
        fireEvent.pointerLeave(screen.getByTestId(SPINNER_TEST_ID));
      ...
      it('the component should handle "pointermove" event', () => {
        ...
        fireEvent.pointerMove(screen.getByTestId(SPINNER_TEST_ID));
      ...
      it('the component should handle "pointerout" event', () => {
        ...
        fireEvent.pointerOut(screen.getByTestId(SPINNER_TEST_ID));
      ...
      it('the component should handle "pointerover" event', () => {
        ...
        fireEvent.pointerOver(screen.getByTestId(SPINNER_TEST_ID));
      ...
      it('the component should handle "pointerup" event', () => {
        ...
        fireEvent.pointerUp(screen.getByTestId(SPINNER_TEST_ID));
  ...
  describe('accessibility', () => {
    ...
    describe('the component should render with the correct accessible role', () => {
      ...
      it('renders correctly with default accessible role', () => {
        ...
        expect(screen.getByTestId(SPINNER_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SPINNER_TEST_ID)).toHaveRole('img');
      });

      it('renders correctly with accessible role', () => {
        const role: SpinnerProps['role'] = 'none';
        render(
          <Spinner
            data-testid={SPINNER_TEST_ID}
            src={InfoIcon}
        ...
        expect(screen.getByTestId(SPINNER_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SPINNER_TEST_ID)).toHaveRole(role);
      });
    ...
    describe('the component should render with the correct accessible name', () => {
      ...
      it('renders correctly without accessible name', () => {
        ...
        expect(screen.getByTestId(SPINNER_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SPINNER_TEST_ID)).not.toHaveAccessibleName();
      });

      it('renders correctly with accessible name', () => {
        const ariaLabel: SpinnerProps['aria-label'] = 'spinner';
        render(
          <Spinner
            data-testid={SPINNER_TEST_ID}
            src={InfoIcon}
        ...
        expect(screen.getByTestId(SPINNER_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(SPINNER_TEST_ID)).toHaveAccessibleName(ariaLabel);
      });
