...
describe('shared/ui/navbar/navbar-group-title', () => {
  ...
  describe('properties', () => {
    ...
    describe('the component should render with the correct "children"', () => {
      ...
      it('renders correctly without "children"', () => {
        render(
          <NavbarGroupTitle data-testid={NAVBAR_GROUP_CONTENT_TEST_ID} />,
          RENDER_OPTIONS
        );
    ...
    describe('the component should render with the correct "className"', () => {
      ...
      it('renders correctly without "className"', () => {
        ...
        expect(screen.getByTestId(NAVBAR_GROUP_CONTENT_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(NAVBAR_GROUP_CONTENT_TEST_ID)).toHaveClass(HeadingClasses['heading']);
      });
      ...
      it('renders correctly with single "className"', () => {
        ...
        expect(screen.getByTestId(NAVBAR_GROUP_CONTENT_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(NAVBAR_GROUP_CONTENT_TEST_ID)).toHaveClass(HeadingClasses['heading'], className1);
      });
      ...
      it('renders correctly with multiple "className"', () => {
        ...
        expect(screen.getByTestId(NAVBAR_GROUP_CONTENT_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(NAVBAR_GROUP_CONTENT_TEST_ID)).toHaveClass(HeadingClasses['heading'], className1, className2);
      });
  ...
  describe('accessibility', () => {
    ...
    describe('the component should render with the correct accessible role', () => {
      ...
      it('renders correctly with default accessible role', () => {
        ...
        expect(screen.getByTestId(NAVBAR_GROUP_CONTENT_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(NAVBAR_GROUP_CONTENT_TEST_ID)).toHaveRole('heading');
      });

      it('renders correctly with accessible role', () => {
        const role: NavbarGroupTitleProps['role'] = 'none';
        render(
          <NavbarGroupTitle
            data-testid={NAVBAR_GROUP_CONTENT_TEST_ID}
            role={role}
    ...
    describe('the component should render with the correct accessible name', () => {
      ...
      it('renders correctly with accessible name', () => {
        const ariaLabel: NavbarGroupTitleProps['aria-label'] = 'navbar-group-title';
        render(
          <NavbarGroupTitle
            data-testid={NAVBAR_GROUP_CONTENT_TEST_ID}
