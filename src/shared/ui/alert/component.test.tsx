  ...
  describe('properties', () => {
    ...
    describe('the component should render with the correct "className"', () => {
      ...
      it('renders correctly without "className"', () => {
        render(
          <Alert
            data-testid={ALERT_TEST_ID}
            title={title}
            text={text}
          />,
          RENDER_OPTIONS
        );
        expect(screen.getByTestId(ALERT_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(ALERT_TEST_ID)).toHaveClass(AlertClasses['alert']);
      });
      ...
      it('renders correctly with single "className"', () => {
        ...
        expect(screen.getByTestId(ALERT_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(ALERT_TEST_ID)).toHaveClass(AlertClasses['alert'], className1);
      });
      ...
      it('renders correctly with multiple "className"', () => {
        ...
        expect(screen.getByTestId(ALERT_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(ALERT_TEST_ID)).toHaveClass(AlertClasses['alert'], className1, className2);
      });
    ...
    describe('the component should render with the correct "text"', () => {
      ...
      it('renders correctly with "text"', () => {
        ...
        expect(screen.getByTestId(ALERT_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(ALERT_TEST_ID)).toHaveTextContent(text);
      });
    ...
    describe('the component should render with the correct "title"', () => {
      ...
      it('renders correctly with "title"', () => {
        ...
        expect(screen.getByTestId(ALERT_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(ALERT_TEST_ID)).toHaveTextContent(title);
      });
    ...
    describe('the component should render with the correct "variant"', () => {
      ...
      it('renders correctly with default "variant"', () => {
        ...
        expect(screen.getByTestId(ALERT_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(ALERT_TEST_ID)).toHaveClass(AlertClasses['alert--variant-outlined']);
      });
      ...
      it('renders correctly with "variant" equal to "destructive"', () => {
        ...
        expect(screen.getByTestId(ALERT_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(ALERT_TEST_ID)).toHaveClass(AlertClasses['alert--variant-destructive']);
      });
  ...
  describe('event handling', () => {
    ...
    describe('keyboard events', () => {
      ...
      it('the component should handle "keydown" event', () => {
        ...
        fireEvent.keyDown(screen.getByTestId(ALERT_TEST_ID));
      ...
      it('the component should handle "keyup" event', () => {
        ...
        fireEvent.keyUp(screen.getByTestId(ALERT_TEST_ID));
    ...
    describe('mouse events', () => {
      ...
      it('the component should handle "click" event', () => {
        ...
        fireEvent.click(screen.getByTestId(ALERT_TEST_ID));
      ...
      it('the component should handle "doubleclick" event', () => {
        ...
        fireEvent.doubleClick(screen.getByTestId(ALERT_TEST_ID));
      ...
      it('the component should handle "mousedown" event', () => {
        ...
        fireEvent.mouseDown(screen.getByTestId(ALERT_TEST_ID));
      ...
      it('the component should handle "mouseenter" event', () => {
        ...
        fireEvent.mouseEnter(screen.getByTestId(ALERT_TEST_ID));
      ...
      it('the component should handle "mouseleave" event', () => {
        ...
        fireEvent.mouseLeave(screen.getByTestId(ALERT_TEST_ID));
      ...
      it('the component should handle "mousemove" event', () => {
        ...
        fireEvent.mouseMove(screen.getByTestId(ALERT_TEST_ID));
      ...
      it('the component should handle "mouseout" event', () => {
        ...
        fireEvent.mouseOut(screen.getByTestId(ALERT_TEST_ID));
      ...
      it('the component should handle "mouseover" event', () => {
        ...
        fireEvent.mouseOver(screen.getByTestId(ALERT_TEST_ID));
      ...
      it('the component should handle "mouseup" event', () => {
        ...
        fireEvent.mouseUp(screen.getByTestId(ALERT_TEST_ID));
      ...
      it('the component should handle "wheel" event', () => {
        ...
        fireEvent.wheel(screen.getByTestId(ALERT_TEST_ID));
    ...
    describe('touch events', () => {
      ...
      it('the component should handle "touchcancel" event', () => {
        ...
        fireEvent.touchCancel(screen.getByTestId(ALERT_TEST_ID));
      ...
      it('the component should handle "touchend" event', () => {
        ...
        fireEvent.touchEnd(screen.getByTestId(ALERT_TEST_ID));
      ...
      it('the component should handle "touchmove" event', () => {
        ...
        fireEvent.touchMove(screen.getByTestId(ALERT_TEST_ID));
      ...
      it('the component should handle "touchstart" event', () => {
        ...
        fireEvent.touchStart(screen.getByTestId(ALERT_TEST_ID));
    ...
    describe('pointer events', () => {
      ...
      it('the component should handle "pointercancel" event', () => {
        ...
        fireEvent.pointerCancel(screen.getByTestId(ALERT_TEST_ID));
      ...
      it('the component should handle "pointerdown" event', () => {
        ...
        fireEvent.pointerDown(screen.getByTestId(ALERT_TEST_ID));
      ...
      it('the component should handle "pointerenter" event', () => {
        ...
        fireEvent.pointerEnter(screen.getByTestId(ALERT_TEST_ID));
      ...
      it('the component should handle "pointerleave" event', () => {
        ...
        fireEvent.pointerLeave(screen.getByTestId(ALERT_TEST_ID));
      ...
      it('the component should handle "pointermove" event', () => {
        ...
        fireEvent.pointerMove(screen.getByTestId(ALERT_TEST_ID));
      ...
      it('the component should handle "pointerout" event', () => {
        ...
        fireEvent.pointerOut(screen.getByTestId(ALERT_TEST_ID));
      ...
      it('the component should handle "pointerover" event', () => {
        ...
        fireEvent.pointerOver(screen.getByTestId(ALERT_TEST_ID));
      ...
      it('the component should handle "pointerup" event', () => {
        ...
        fireEvent.pointerUp(screen.getByTestId(ALERT_TEST_ID));
  ...
  describe('accessibility', () => {
    ...
    describe('the component should render with the correct accessible role', () => {
      ...
      it('renders correctly with default accessible role', () => {
        ...
        expect(screen.getByTestId(ALERT_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(ALERT_TEST_ID)).toHaveRole('alert');
      });

      it('renders correctly with accessible role', () => {
        const role: AlertProps['role'] = 'none';
        render(
          <Alert
            data-testid={ALERT_TEST_ID}
            title={title}
        ...
        expect(screen.getByTestId(ALERT_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(ALERT_TEST_ID)).toHaveRole(role);
      });
    ...
    describe('the component should render with the correct accessible name', () => {
      ...
      it('renders correctly without accessible name', () => {
        ...
        expect(screen.getByTestId(ALERT_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(ALERT_TEST_ID)).not.toHaveAccessibleName();
      });

      it('renders correctly with accessible name', () => {
        const ariaLabel: AlertProps['aria-label'] = 'alert';
        render(
          <Alert
            data-testid={ALERT_TEST_ID}
            title={title}
        ...
        expect(screen.getByTestId(ALERT_TEST_ID)).toBeInTheDocument();
        expect(screen.getByTestId(ALERT_TEST_ID)).toHaveAccessibleName(ariaLabel);
      });
